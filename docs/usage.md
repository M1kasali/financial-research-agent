...
本文汇总离线运行、数据接入、模型调用及历史脚本的使用边界。项目背景与示例见[项目首页](../README.md)。命令均从仓库根目录执行。
...
参赛阶段的跨文档条款比较与逐选项推理设计见[核心接入说明](v45-core-integration-2026-09-14.md)及[原团队仓库](https://github.com/XxJjTt6/afac2026-financial-longtext-agent-team)。当前工程入口与原提交的关系见[来源说明](../NOTICE.md)。
...
- [计算与补查闭环](core-research-2026-09-14.md)
- [问答与引用核验](core-answer-2026-09-14.md)
- [可见原文片段 ID](citation-spans-2026-09-14.md)
- [财务工具边界](financial-workflow-2026-09-14.md)
- [小规模真实开发对照](core-comparison-2026-09-14.md)
- [引用模式对照及失败记录摘要](live-citation-comparison-2026-09-14.md)
- [首次私有发布检查](publication-checklist.md)
